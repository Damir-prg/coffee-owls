import api from '../api';
import { ICreateComment, ICreateTopic, ITopicComment, ITopicDetails, ITopicItem, IID } from './forumApi.interface';
...
export const createTopic = (data: ICreateTopic): Promise<IID | null> => {
